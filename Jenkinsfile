    ...
    stages {
        ...
        stage('Deploy demo-2') {
            steps {
                ...
                sh ' scp -i id_rsa /var/jenkins_home/workspace/test-microservice/demo_2/target/demo-2.jar root@192.168.1.9:~/demo-2/'
                sh ' scp -i id_rsa /var/jenkins_home/workspace/test-microservice/demo_2/Dockerfile root@192.168.1.9:~/demo-2/'
        ...
        stage('Deploy test-1') {
            steps {
                ...
                // Copy the built .jar file to the EC2 instance
                sh ' scp -i id_rsa /var/jenkins_home/workspace/test-microservice/test-1/target/test-1.jar root@192.168.1.9:~/test-1/'
                sh ' scp -i id_rsa /var/jenkins_home/workspace/test-microservice/test-1/Dockerfile root@192.168.1.9:~/test-1/'
